...
class ModificarResumenForm(forms.ModelForm):
    ...
    class Meta:
        model = Resumen
        fields = ('descripcion', 'empleado', 'paciente', 'revisado')
...
class AgregarConsolidadoForm(forms.ModelForm):
    fecha = forms.DateField(required=False)
    def __init__(self, *args, **kwargs):
        super(AgregarConsolidadoForm, self).__init__(*args, **kwargs)
        self.fields['descripcion'].widget.attrs['placeholder'] = ""

    class Meta:
        model = Consolidado
        fields = ('fecha', 'descripcion', 'paciente', 'fecha_inicio', 'fecha_fin')
        widgets = {
            "descripcion": forms.Textarea(attrs={'rows': 25, 'style': 'resize:none;'}),
            "paciente": Select2Widget(),
...
class GenerarConsolidadoForm(forms.ModelForm):
    fecha = forms.DateField(required=False)
    def __init__(self, *args, **kwargs):
        super(AgregarConsolidadoForm, self).__init__(*args, **kwargs)
        self.fields['descripcion'].widget.attrs['placeholder'] = ""
